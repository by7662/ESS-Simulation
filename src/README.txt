...
How to compile:
In terminal, go to the correct directory. In this case, [proj02--> src]. Then execute javac src.Simulation.java to
compile.

How to run program:
After compiling, execute java src.Simulation. Followed by required program argument. This can be referred by
...
The src.Individual class will be the great justification on one of the reasons why I think using Java makes more sense.
...
project, the src.Simulation shows the a few patterns in terms of game theory. For example, when the number of Doves is the
